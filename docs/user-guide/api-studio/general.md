...
│ - Splitter / Mixer   │ - Connections carry streams of items     │ - Last run results   │
│ - Generator          │                                          │                      │
│ - Delay              │                                          │                      │
└──────────────────────┴──────────────────────────────────────────┴──────────────────────┘
...
3. **Unambiguous wiring**: An input takes exactly one connection, so a value is never ambiguously merged; an output may feed as many inputs as you like. Combine values with a **Mixer**, take objects apart with a **Splitter**.
